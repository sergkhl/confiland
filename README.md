...
Real Web Audio sources and output signals were measured in the local browser. The recorded clap starts exactly 780 ms into the seal; muting during anticipation stops it before playback and unmuting does not replay it. Offline renders of rub/pop/seal peaked at 0.023/0.123/0.323 with the existing master gain, and missing-sample or suspended-cancelled reduced-motion renders were exactly zero. Earlier sound acceptance also covered audio-context suspension/resume, failed answer/tap/seal writes, the Not today shortcut and silent WebMCP review updates. Physical speakers/headphones were not auditioned; OS audio interruptions and reduced-motion preference switching were not exercised. The current immediate-clap reduced-motion branch was rendered offline. The owner-requested sound update is published at https://confiland.globesoul.com/: all 24 checked public assets load, the recording matches committed bytes, and the isolated live demo passes matching effort previews, Doable routing, twenty taps, explicit sealing, reload and review closure without browser warnings/errors. Deployment evidence is recorded in the completed plan.
