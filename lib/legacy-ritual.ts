...
type Phase = 'choosing' | 'sealed' | 'pulling' | 'away' | 'returning' | 'returned';
type Ritual = { version: 1; id: string; date: string; selected: 'hello' | 'start' | null; phase: Phase; pull: number; outcome: 'done' | 'tried' | 'not_today' | null };
