...
- All 74 tests, TypeScript, targeted lint, GitHub Pages static export and normal Worker build pass. The final static browser loads the recorded asset and live poses without console warnings/errors. Sound/save/font fixtures are removed and no release manifest or substitute status file was introduced.
